...
if __name__ == "__main__":
    ...
    if util.config["instruments"]["mm"]["module"] != "Fluke_45":
        raise Exception(util.Red("The multimeter 'Fluke_45' is not defined in config"))

    mm = Fluke_45(util.config["instruments"]["mm"]["port"])
    util.Purple(mm)
