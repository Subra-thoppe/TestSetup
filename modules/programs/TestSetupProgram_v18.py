...
#13,02,25 V18- - adapting to git release dt,13,02,25 # writescnasenspartno
        ...
        if i==0:
            ...
            #exit()
                ...
                #for i in range (len(dfsp)-1): # ONLT WRITING COMPSERT ONCE
                    ...
                    #1.clsoe Relays to communicate with ch A 
                    ...
                    # Read Norbit serial no 
                    # git rev 13.02.25 no change                                      
